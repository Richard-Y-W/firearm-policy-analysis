...
DATA = ROOT / "data" / "processed" / "analysis_panel_firearm_homicide_deaths_1999_2024.csv"
...
def main():
    ...
    results_df.to_csv(OUT_TABLES / "welch_results_firearm_homicide_deaths.csv", index=False)

    if state_scores is not None:
        state_scores.to_csv(OUT_TABLES / "state_level_A_3y_firearm_homicide_deaths.csv", index=False)

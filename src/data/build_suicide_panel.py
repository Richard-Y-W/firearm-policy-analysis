...
def main():
    old_file = CDC_DIR / "firearm_suicide_1999_2020.xls"
    new_file = CDC_DIR / "firearm_suicide_2018_2024_single_race.xls"
    ...
    panel.to_csv(OUT_DIR / "analysis_panel_firearm_suicide_deaths_1999_2024.csv", index=False)
    ...
    print("Saved:")
    print(OUT_DIR / "analysis_panel_firearm_suicide_deaths_1999_2024.csv")
